...
2. [ifrs_struct.h](https://github.com/marcelogm/IFRSLib/blob/master/README.md#ifrs_structh)
  1. [Structures](https://github.com/marcelogm/IFRSLib/blob/master/README.md#structures-1)
    - [Array implementation](https://github.com/marcelogm/IFRSLib/blob/master/README.md#array-implementation)
    ...
    - [Linked-List Implementation](https://github.com/marcelogm/IFRSLib/blob/master/README.md#linked-list-implementation) 
